...
- **No commit message may mention Claude or Anthropic, in any form** (`Co-Authored-By:
  ...
  the same script over every commit in a PR as a second, clone-independent net. None of this
  touches file/diff content, only the commit message: a patch can legitimately carry a real
