...
`pypi.riseproject.dev`. The 189 hard-won "gotchas" are split by theme under
...
- **[references/gotchas-index.md](references/gotchas-index.md)** — the router for all 189
...
The 189 gotchas are split into themed files under `references/gotchas/`. **Read the one file
