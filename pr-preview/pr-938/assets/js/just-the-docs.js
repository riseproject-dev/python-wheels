...
function initSearch() {
  ...
  request.open('GET', '/python-wheels/pr-preview/pr-938/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/python-wheels/pr-preview/pr-938/assets/css/just-the-docs-' + theme + '.css');
}
